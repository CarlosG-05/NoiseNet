#!/bin/bash
# ==============================================================================
# Stratum-1 Timing System: Automated Test Suite
# ==============================================================================
...
function show_menu() {
    ...
    echo "========================================================================="
    echo " 1) Phase 1 & 2: Time Travel & GPS Recovery Test"
...
function test_time_travel() {
    ...
    echo "[+] Setting system time to 14 days ago..."
    date -s "14 days ago"

    echo "[+] Wiping RTC memory (Setting to Jan 1, 2000)..."
    hwclock --set --date="2000-01-01 00:00:00"
    ...
    echo "[+] Forcing Chrony to Makestep (snapping the clock)..."
    sleep 2
    chronyc makestep
...
function test_rtc_sync_logger() {
    echo "[+] Sabotaging RTC Time (Setting to May 5, 2010)..."
    hwclock --set --date="2010-05-05 12:00:00"
